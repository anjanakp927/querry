...
class SaleQuotationReport(models.Model):
    _name = "sale.quotation.report"
    _description = "Sales Quotation Analysis Report"
    _auto = False
    _rec_name = 'date'
    _order = 'date desc'
    ...
    quotation_id = fields.Many2one('sale.quotation', 'Order #', readonly=True)
    ...
    def _query(self, with_clause='', fields={}, groupby='', from_clause=''):
        ...
        from_ = """
                sale_quotation_line l
                      join sale_quotation s on (l.quotation_id=s.id)
